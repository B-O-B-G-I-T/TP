...
public class Personne implements Comparable<Personne>{
	 ...
	 */
	public Personne(String leNom,String lePrenom, int age, int j, int m, int a, int numero, String rue, String code_postal, String ville){
		this(leNom, lePrenom, age, LocalDate.of(a,m,j),new Adresse(numero,rue,code_postal,ville));
